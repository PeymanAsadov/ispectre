...
const enHome = {
  ...
  "carousel": [
    ...
    { "sub": "6.1 IN · 128GB · PINK", "title": "iPhone 15, 128 GB, Pink" },
    { "sub": "6.7 IN · 128GB · TEAL", "title": "iPhone 16, 128 GB, Teal" },
    { "sub": "13.6 IN · 256GB · MIDNIGHT", "title": "MacBook Air M5" }
  ],
...
const azHome = {
  ...
  "services": [
    ...
    { "label": "MALİYYƏ", "title": "Xüsusi maliyyələşdirmə. Faizziz, hissə-hissə ödəyin" },
  ...
  "carousel": [
    ...
    { "sub": "6.1 İN · 128GB · ÇƏHRAYI", "title": "iPhone 15, 128 GB, Çəhrayı" },
    { "sub": "6.7 İN · 128GB · FIRUZƏYI", "title": "iPhone 16, 128 GB, Firuzəyi" },
    { "sub": "13.6 İN · 256GB · GECƏ YARISI", "title": "MacBook Air M5" }
  ],
...
const ruHome = {
  ...
  "carousel": [
    { "sub": "13.6 ДЮЙМОВ · 256 ГБ · ОРАНЖЕВЫЙ", "title": "iPhone 17 Pro, 256 ГБ, Cosmic Orange" },
    { "sub": "6.1 ДЮЙМОВ · 128 ГБ · РОЗОВЫЙ", "title": "iPhone 15, 128 ГБ, Розовый" },
    { "sub": "6.7 ДЮЙМОВ · 128 ГБ · БИРЮЗОВЫЙ", "title": "iPhone 16, 128 ГБ, Бирюзовый" },
    { "sub": "13.6 ДЮЙМОВ · 256 ГБ · ТЕМНАЯ НОЧЬ", "title": "MacBook Air M5" }
  ],
