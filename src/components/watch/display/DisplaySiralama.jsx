...
function DisplaySiralama({ title, displays = [] }) {
  ...
  const filterSidebar = (
    <div className="space-y-6">
      ...
      {allStorages.length > 1 && (
        <div className="bg-white dark:bg-[#1c1c1e] rounded-3xl p-6 border border-gray-100 dark:border-gray-700/50 shadow-sm">
          <h3 className="font-bold text-xl mb-5 text-gray-900 dark:text-gray-100">{t('filters.glass_type')}</h3>
          <div className="space-y-4">
            {allStorages.map((s) => (
...
export default DisplaySiralama;