...
const DisplayProductCard = memo(({ item }) => {
...
function DisplayCard({
  ...
  const cards = useMemo(() => {
    ...
    displays.forEach((d) => {
      if (selectedModels.length && !selectedModels.includes(d.model)) return;

      d.colors?.forEach((colorObj) => {
    ...
    return result;
  }, [displays, minPrice, maxPrice, selectedModels, selectedColor, selectedStorage, sortBy]);
