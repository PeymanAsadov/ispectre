...
function IphoneDetail() {
  ...
  const specs = useMemo(() => {
    ...
    if (product.camera) list.push({ name: "Camera", value: product.camera });
    ...
    return (
      <div className="w-full min-h-screen bg-[#f5f5f7] dark:bg-[#0f0f13] flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-gray-500 dark:text-gray-400 font-medium">Məhsul yüklənir...</p>
        </div>
      </div>
    );
  }
  ...
  if (!product) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-[#f5f5f7] dark:bg-[#0f0f13] gap-4">
        <h1 className="text-3xl font-semibold text-gray-900 dark:text-gray-100">Məhsul tapılmadı</h1>
    ...
    <div className="w-full min-h-screen bg-[#f5f5f7] dark:bg-[#0f0f13] text-[#1d1d1f] dark:text-gray-100 pb-24 animate-fade-in">
      <div className="max-w-7xl mx-auto px-6 pt-12">
        <div className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400 mb-8">
          <Link to="/" className="hover:text-black dark:hover:text-white">Ana səhifə</Link>
          <span>/</span>
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-start">
            ...
            <div className="w-full lg:w-96 flex-shrink-0">
              ...
              <p className="mt-2 text-base text-gray-500 dark:text-gray-400">
                Seçilmiş rəng : <span className="text-black dark:text-white font-medium ml-1">{color?.name}</span>
              </p>
              ...
              <div className="mt-6 bg-[#f5f5f7] dark:bg-[#232326] rounded-3xl p-5 border border-gray-100 dark:border-gray-700/50">
                ...
                <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">Nağd / Kartla ödəniş</p>
                <div className="border-t border-gray-200 dark:border-gray-700 mt-4 pt-4">
                  <p className="text-lg font-bold text-blue-600 dark:text-blue-400">
                    {monthly} ₼ <span className="text-xs text-gray-500 dark:text-gray-400 font-normal">/ ay</span>
                  </p>
                  <p className="text-[11px] text-gray-400 dark:text-gray-500">12 ay faizsiz taksit</p>
                </div>
              </div>

              <div className="mt-8">
                <h3 className="text-xs font-bold uppercase tracking-wider text-gray-400 dark:text-gray-500 mb-3">Color</h3>
              ...
              <div className="mt-8">
                <h3 className="text-xs font-bold uppercase tracking-wider text-gray-400 dark:text-gray-500 mb-3">Yaddaş</h3>
              ...
              <button
                ...
                disabled={added}
                className={`w-full mt-8 py-4 rounded-2xl transition text-white font-semibold ${added ? "bg-green-600" : "bg-black hover:bg-gray-800 dark:bg-slate-700 dark:hover:bg-slate-600"
                  }`}
              >
        ...
        <div className="mt-16">
          <h2 className="text-2xl font-bold mb-6">Sizə də xoş gələ bilər</h2>
          <div
            ref={sliderRef}
