  ...
  if (!product) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-[#f5f5f7] dark:bg-[#0f0f13] gap-4">
        ...
        <Link to="/airpods" className="text-blue-600 dark:text-blue-400 hover:underline">
    ...
    <div className="w-full min-h-screen bg-[#f5f5f7] dark:bg-[#0f0f13] text-[#1d1d1f] dark:text-gray-100 pb-24 animate-fade-in">
      <div className="max-w-7xl mx-auto px-6 pt-12">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400 mb-8">
          ...
          <span>/</span>
          <Link to="/airpods" className="hover:text-black dark:hover:text-white transition-colors">AirPods</Link>
          <span>/</span>
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-start">
            ...
            <div className="w-full lg:w-96 flex-shrink-0">
              ...
              <div className="mt-8 border border-gray-200 dark:border-gray-700/50 rounded-3xl overflow-hidden">
                ...
                <div className="flex justify-between items-center px-5 py-4 text-sm border-b border-gray-100 dark:border-gray-700/50">
